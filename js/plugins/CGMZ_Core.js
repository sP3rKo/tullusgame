 ...
 * rename the js file.
 * --------------------------Latest Version------------------------------------
 * Hi all, this latest version adds some utility functions for things like
 * checking the current scene, doing a random roll for success, and adds a few
 * more safety checks in some functions to try and prevent any errors.
 *
 * This update also added a function to log information to the console with
 * some formatting, to make it consistent throughout [CGMZ] plugins.
 *
 * This update removes the [CGMZ] fix for icons not drawing properly in some
 * cases as RPG Maker 1.10.0 also fixed this issue.
 *
 * Version 1.35.0
...
var CGMZ = {};
CGMZ.Versions = {};
CGMZ.Versions["CGMZ Core"] = "1.35.0";
CGMZ.Core = {};
