...
/*:
 * @plugindesc Simple Lorebook MV Patch (ABOVE!)
 ...
 * @help
 *
 * ! This plugin must be ABOVE Simple Lorebook plugin in the plugin list !
 *  
 * 
 *  This plugin patch adds scrollable window functionality to RPG Maker MV,
 *  that requires for Simple Lorebook plugin.
 * 
 */
...
if(Utils.RPGMAKER_NAME.includes("MV") == false) {
    window.alert("PKD_SimpleLorebook_PatchForMV.js is for RPG Maker MV only. It won't work in MZ. Disable it!");
    return;
}
